    ...
    <div class="page-content">
        ...
        <div class="row">
	        <div class="col-md-12">
	            ...
	            <form action="/product/save/category.dr" id="form" class="form-horizontal form-row-seperated" method="POST" enctype="multipart/form-data">
...
$('#button-submit').on('click', function() {
	var action = '/product/save/category.dr';
	var DATA='';
