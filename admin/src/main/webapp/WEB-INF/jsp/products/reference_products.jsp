...
<div class="page-content-wrapper">
    <div class="page-content">
        <h1 class="page-title"> 참조된 제품 찾기</h1>
        ${ctag:getSuccess(successMsg)}
        ${ctag:getError(errroMsg)}
        <div class="row">
	        <div class="col-md-12">
	        	<!-- BEGIN FORM-->
	            <form action="/products/reference.dr" id="form" class="horizontal-form">
	                    	...
	                    	<div class="table-responsive">
			                    <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_orders">
									...
									<c:forEach items="${products}" var="item">
										<tr role="row">
											<td class="text-align-left"><a href="/product/view/meta/${item.product_id}/${item.language_id}.dr" target="_blank">${item.name}</a></td>
										</tr>
									</c:forEach>
									</tbody>
	                    	...
	                    	<div class="table-responsive">
			                    <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_orders">
									...
									<c:forEach items="${healths}" var="item">
										<tr role="row">
											<td class="text-align-left"><a href="/contents/security/health/contents/${item.contents_id}/${item.language_id}.dr" target="_blank">${item.title}</a></td>
										</tr>
									</c:forEach>
									</tbody>
	                    	...
	                    	<div class="table-responsive">
			                    <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_orders">
									...
									<c:forEach items="${clinics}" var="item">
										<tr role="row">
											<td class="text-align-left"><a href="/contents/security/clinic/contents/${item.contents_id}/${item.language_id}.dr" target="_blank">${item.title}</a></td>
										</tr>
									</c:forEach>
									</tbody>
	                    	...
	                    	<div class="table-responsive">
			                    <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_orders">
									...
									<c:forEach items="${diseases}" var="item">
										<tr role="row">
											<td class="text-align-left"><a href="/contents/security/disease/contents/${item.contents_id}/${item.language_id}.dr" target="_blank">${item.title}</a></td>
										</tr>
									</c:forEach>
									</tbody>
									...
									<c:forEach items="${medicinese}" var="item">
										<tr role="row">
											<td class="text-align-left">
												<a href="/contents/security/disease/contents/${item.contents_id}/${item.language_id}.dr#tab-data" target="_blank">
													<c:choose>
