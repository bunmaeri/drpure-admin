...
<div class="page-content-wrapper">
    <div class="page-content">
        <h1 class="page-title"> <span style="color:red">[My Home Doc]</span> Sales Orders</h1>
	        ...
	        <div class="col-md-12">
	            ...
	            <div class="portlet box blue">
	                ...
	                <div class="portlet-body form">
	                    <!-- BEGIN FORM-->
	            		<form action="/my_reports/sales/order.dr" id="form" class="horizontal-form">
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-3">
			                    ...
			                    <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_orders">
		                            <thead>
		                                <tr role="row" class="heading">
											...
											<td class="text-align-right">No. Orders</td>
											<td class="text-align-right">No. Products</td>
											<td class="text-align-right">Tax</td>
...
$('#button-submit').on('click', function() {
	var action = '/my_reports/sales/order.dr';
	$('#page').val(1);
	$('#click_page').val(1);
