...
<div class="page-content-wrapper">
    <div class="page-content">
        <h1 class="page-title"> <span style="color:red">[My Home Doc]</span> Sales Shipping</h1>
	        ...
	        <div class="col-md-12">
	            ...
	            <div class="portlet box blue">
	                ...
	                <div class="portlet-body form">
	                    <!-- BEGIN FORM-->
	            		<form action="/my_reports/sales/shipping.dr" id="form" class="horizontal-form">
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-3">
...
$('#button-submit').on('click', function() {
	var action = '/my_reports/sales/shipping.dr';
	$('#page').val(1);
	$('#click_page').val(1);
