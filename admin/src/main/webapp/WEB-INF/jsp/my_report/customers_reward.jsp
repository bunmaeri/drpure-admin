...
<div class="page-content-wrapper">
    <div class="page-content">
        <h1 class="page-title"> <span style="color:red">[My Home Doc]</span> Customer Reward Points</h1>
	        ...
	        <div class="col-md-12">
	            ...
	            <div class="portlet box blue">
	                ...
	                <div class="portlet-body form">
	                    <!-- BEGIN FORM-->
	            		<form action="/my_reports/customers/reward.dr" id="form" class="horizontal-form">
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-3">
			                    ...
			                    <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_orders">
		                            <thead>
		                                <tr role="row" class="heading">
											...
											<td class="text-align-left" width="30%">E-Mail</td>
											<td class="">Customer Group</td>
											<td class="text-align-right">Reward Points</td>
											<td class="text-align-right">No. Order</td>
		                            ...
		                            <c:forEach items="${list}" var="list">
										<tr>
											<td class="text-align-left">${list.customer_name}</td>
											<td class="text-align-left">${list.email}</td>
											<td class="">${list.customer_group}</td>
											<td class="text-align-right">${ctag:getNumber(list.points)}</td>
											<td class="text-align-right">${ctag:getNumber(list.orders)}</td>
											<td class="text-align-right">${ctag:getCurrency(list.total)}</td>
											<td class=""><a href="/customer/view/${list.customer_id}.dr" target="_blank" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
										</tr>
									</c:forEach>
		                            </tbody>
		                        </table>
...
$('#button-submit').on('click', function() {
	var action = '/my_reports/customers/reward.dr';
	$('#page').val(1);
	$('#click_page').val(1);
