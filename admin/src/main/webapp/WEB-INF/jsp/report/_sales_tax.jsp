...
<div id="content">
	<div class="page-header">
		<div class="container-fluid">
			...
			<ul class="breadcrumb">
				<li><a href="/">첫화면</a></li>
				<li><a href="/report/sales/tax.dr">Tax Report</a></li>
			</ul>
		</div>
	</div>
	<div class="container-fluid">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title">
					<i class="fa fa-bar-chart"></i> Tax List
				</h3>
			</div>
			<div class="panel-body">
				<div class="well">
					<div class="row">
					<form action="/report/sales/tax.dr" method="post" id="form">
						<div class="col-sm-3">
...
function goMovePage(page) {
    ...
    comSubmit.setUrl("<c:url value='/report/sales/tax.dr' />");
