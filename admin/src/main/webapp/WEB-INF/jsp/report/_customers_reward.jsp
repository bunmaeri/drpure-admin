...
<div id="content">
	<div class="page-header">
		<div class="container-fluid">
			...
			<ul class="breadcrumb">
				<li><a href="/">첫화면</a></li>
				<li><a href="/report/customers/reward.dr">Customer Reward Points Report</a></li>
			</ul>
		</div>
	</div>
	<div class="container-fluid">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title">
					<i class="fa fa-bar-chart"></i> Customer Reward Points List
				</h3>
			</div>
					...
					<table class="table table-bordered">
						...
						<c:forEach items="${list}" var="list">
							<tr>
								...
								<td class="text-right">${ctag:getNumber(list.points)}</td>
								<td class="text-right">${ctag:getNumber(list.orders)}</td>
								<td class="text-right">${ctag:getCurrency(list.total)}</td>
								<td class="text-center"><a href="/customer/customer/edit/${list.customer_id}.dr" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
							</tr>
						</c:forEach>
						</tbody>
					</table>
...
function goMovePage(page) {
    ...
    comSubmit.setUrl("<c:url value='/report/customers/reward.dr' />");
