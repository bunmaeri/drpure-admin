    ...
    <div class="page-content">
        ...
        <div class="row">
	        <div class="col-md-12">
	            ...
	            <form action="/my_contents/notice/save.dr" id="form" class="form-horizontal form-row-seperated">
	                        				...
	                        				<div class="col-md-1" style="width:11%">
	                        					...
	                        					<c:forEach items="${languages}" var="item">
	                        						<li <c:if test="${item.language_id==language_id}">class="active"</c:if>>
	                        							<a data-toggle="tab" href="javascript:;" onclick="javascript:location='/my_contents/notice/info/${contents_id}/${item.language_id}.dr'">
...
$('#button-submit').on('click', function() {
    $.ajax({
        url: '/my_contents/notice/save.dr',
        type: 'post',
