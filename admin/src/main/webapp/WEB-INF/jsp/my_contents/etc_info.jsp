...
<div class="page-content-wrapper">
    <div class="page-content">
        <h1 class="page-title"> <span style="color:red">[My Home Doc]</span> 기타 컨텐츠 수정</h1>
        ${ctag:getSuccess(successMsg)}
        ${ctag:getError(errroMsg)}
        <div class="row">
	        <div class="col-md-12">
	            <!-- Begin: life time stats -->
	            <form action="/my_contents/etc/save.dr" id="form" class="form-horizontal form-row-seperated">
	            	<div class="portlet light portlet-fit portlet-datatable bordered">
		                <div class="portlet-title">
		                    <div class="caption">
		                        <i class="icon-settings font-dark"></i>
		                        <span class="caption-subject font-dark sbold uppercase"> 제목: ${contents.title}</span>
		                    </div>
		                    <div class="actions">
	                    		<button type="button" class="btn dark" id="button_back" onclick="javascript:location='/my_contents/etc.dr'"><i class="fa fa-reply"></i> BACK</button>
	                    ...
	                    <div class="portlet-body">
	                        <div class="tabbable-bordered">
	                            ...
	                            <div class="tab-content">
	                        				...
	                        				<div class="col-md-1" style="width:11%">
	                        					...
	                        					<c:forEach items="${languages}" var="item">
	                        						<li <c:if test="${item.language_id==language_id}">class="active"</c:if>>
	                        							<a data-toggle="tab" href="javascript:;" onclick="javascript:location='/my_contents/etc/info/${contents_id}/${item.language_id}.dr'">
					                        ...
					                        <div class="col-md-11" style="width:86%">
			                                    <div class="form-body">
													...
													<div class="form-group class-sort-order">
														<label class="control-label" for="sort_order">사용하는 메뉴 위치</label>
														<input type="text" name="etc" value="${info.etc}" placeholder="" id="etc" class="form-control" />
													</div>
	                                ...
	                                <input type="hidden" name="sort_order" value="0" id="sort_order" />
	                            </div>
	                        </div>
	                    </div>
	                </div>
					...
					<input type="hidden" name="code" id="code" value="etc">
	            </form>
	        </div>
	    </div>
...
$('#button-submit').on('click', function() {
    $.ajax({
        ...
        success: function(json) {
            ...
            if(json.Error) {
            	$('.page-title').after('<div class="custom-alerts alert alert-danger fade in"><button type="button" class="close" data-dismiss="alert" aria-hidden="true"></button><i class="fa-lg fa fa-warning"></i>에러 메세지를 확인하세요.</div>');
            	if (json.Error.title) {
