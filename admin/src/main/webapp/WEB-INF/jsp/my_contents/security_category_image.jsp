    ...
    <div class="page-content">
        ...
        <div class="row">
	        <div class="col-md-12">
	            ...
	            <form action="/my_contents/security/category/save/image.dr" id="form" class="form-horizontal form-row-seperated" method="POST" enctype="multipart/form-data">
...
$('#button-submit').on('click', function() {
    $.ajax({
        url: '/my_contents/security/category/save/image.dr',
        type: 'post',
        data: $('#form input'),
        dataType: 'json',
        beforeSend: function() {
...
$('#button_back').on('click', function() {
	var action = '/my_contents/security/categories.dr';
