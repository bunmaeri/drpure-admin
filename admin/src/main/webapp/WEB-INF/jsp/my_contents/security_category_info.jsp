    ...
    <div class="page-content">
        ...
        <div class="row">
	        <div class="col-md-12">
	            ...
	            <form action="/my_contents/security/category/save.dr" id="form" class="form-horizontal form-row-seperated">
	            	<div class="portlet light portlet-fit portlet-datatable bordered">
		                <div class="portlet-title">
		                    ...
		                    <div class="actions">
	                    		<button type="button" class="btn dark" id="button_back" onclick="javascript:location='/my_contents/security/categories.dr'"><i class="fa fa-reply"></i> BACK</button>
	                    ...
	                    <div class="portlet-body">
	                        <div class="tabbable-bordered">
	                            <ul class="nav nav-tabs">
                            	    <li class="active">
	                                    <a href="javascript:;" onclick="javascript:location='/my_contents/security/category/info/${code}/${language_id}.dr'" data-toggle="tab"> Edit </a>
	                                </li>
	                                <li>
	                                    <a href="javascript:;" onclick="javascript:location='/my_contents/security/category/image/${code}/${language_id}.dr'" data-toggle="tab"> 이미지 </a>
	                                </li>
		                        </ul>
	                        				...
	                        				<div class="col-md-1" style="width:11%">
	                        					...
	                        					<c:forEach items="${languages}" var="item">
	                        						<li <c:if test="${item.language_id==language_id}">class="active"</c:if>>
	                        							<a data-toggle="tab" href="javascript:;" onclick="javascript:location='/my_contents/security/category/info/${code}/${item.language_id}.dr'">
...
$('#button-submit').on('click', function() {
    $.ajax({
        url: '/my_contents/security/category/save.dr',
        type: 'post',
