...
<div class="page-content-wrapper">
    <div class="page-content">
        <h1 class="page-title"> <span style="color:red">[My Home Doc]</span> 책 정보 수정 <small>edit book</small></h1>
        ${ctag:getSuccess(successMsg)}
        ${ctag:getErrorList(errroMsg)}
        <div class="row">
	        <div class="col-md-12">
	            <!-- Begin: life time stats -->
	            <form action="/my_contents/book/save.dr" id="form" class="form-horizontal form-row-seperated" method="POST" enctype="multipart/form-data">
	            	<div class="portlet light portlet-fit portlet-datatable bordered">
		                <div class="portlet-title">
		                    ...
		                    <div class="actions">
	                    		<button type="button" class="btn dark" id="button_back" onclick="javascript:location='/my_contents/books.dr'"><i class="fa fa-reply"></i> BACK</button>
	                        				...
	                        				<div class="col-md-1" style="width:11%">
	                        					...
	                        					<c:forEach items="${languages}" var="item">
	                        						<li <c:if test="${item.language_id==language_id}">class="active"</c:if>>
	                        							<a data-toggle="tab" href="javascript:;" onclick="javascript:location='/my_contents/book/${book_id}/${item.language_id}.dr'">
