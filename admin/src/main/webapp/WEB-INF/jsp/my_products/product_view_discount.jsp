    ...
    <div class="page-content">
        ...
        <div class="row">
	        <div class="col-md-12">
	            ...
	            <form action="/my_product/save/discount.dr" id="form" class="form-horizontal form-row-seperated">
...
$('#button-submit').on('click', function() {
	var action = '/my_product/save/discount.dr';
...
function goDelete(product_special_id) {
	...
	var action = '/my_product/delete/discount.dr';
