    ...
    <div class="page-content">
        ...
        <div class="row">
	        <div class="col-md-12">
	            ...
	            <form action="/my_product/save/info.dr" id="form" class="form-horizontal form-row-seperated">
...
function goDelete(product_id) {
	if(confirm('삭제하시겠습니까?')) {
		var action = '/my_product/remove/'+product_id+'.dr';
