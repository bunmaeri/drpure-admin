    ...
    <div class="page-content">
        ...
        <div class="row">
	        <div class="col-md-12">
	            ...
	            <form action="/my_category/save/meta.dr" id="form" class="form-horizontal form-row-seperated">
	                        				...
	                        				<div class="col-md-1" style="width:11%">
	                        					...
	                        					<c:forEach items="${languages}" var="item">
	                        						<li <c:if test="${item.language_id==language_id}">class="active"</c:if>>
	                        							<a data-toggle="tab" href="javascript:;" onclick="javascript:location='/my_category/view/meta/${category_id}/${item.language_id}.dr'">
        ...
        success: function(json) {
            ...
            if (json.success) {
                ...
                if (json.success_category_id) {
                	var url = '/my_category/view/meta/'+json.success_category_id+'/'+json.success_language_id+'.dr';
