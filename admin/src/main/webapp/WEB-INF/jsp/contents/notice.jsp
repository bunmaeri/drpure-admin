...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <div class="row">
	        <div class="col-md-12">
	        	<!-- BEGIN FORM-->
	            <form action="/contents/notice/delete.dr" id="form" class="horizontal-form">
	                ...
	                <div class="portlet-body form">
	                    <div>
	                        <div class="form-actions right">
	                        	<a href="/contents/notice/add.dr" data-toggle="tooltip" title="새로 추가" class="btn green"><i class="fa fa-plus"></i> 추가</a>
	                        </div>
                        </div>
	                </div>
	            </div>
...
function goDelete(information_id) {
	if(confirm('삭제하시겠습니까?')) {
		var action = '/contents/notice/delete/'+contents_id+'.dr';
		$("#form").attr("action", action);
		$('#form').submit();
	}
}
