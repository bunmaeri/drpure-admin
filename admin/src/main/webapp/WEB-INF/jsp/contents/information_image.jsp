    ...
    <div class="page-content">
        ...
        <div class="row">
	        <div class="col-md-12">
	            ...
	            <form action="/contents/information/save/image.dr" id="form" class="form-horizontal form-row-seperated" method="POST" enctype="multipart/form-data">
...
$('#button-submit').on('click', function() {
    $.ajax({
        url: '/contents/information/save/image.dr',
        type: 'post',
        data: $('#form input'),
        dataType: 'json',
        beforeSend: function() {
