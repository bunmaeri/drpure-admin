...
<div class="page-content-wrapper">
    <div class="page-content">
        <h1 class="page-title"> 책 <small>Books</small></h1>
        ${ctag:getSuccess(successMsg)}
        ${ctag:getError(errroMsg)}
        <div class="row">
	        <div class="col-md-12">
	        	<!-- BEGIN FORM-->
	            <form action="/contents/books.dr" id="form" class="horizontal-form">
	                ...
	                <div class="portlet-body form">
	                    <div>
	                        <div class="form-actions right">
	                        	<a href="/contents/book/add.dr" data-toggle="tooltip" title="새로 추가" class="btn green"><i class="fa fa-plus"></i> 추가</a>
	                        </div>
                        </div>
	                </div>
	            </div>
			                    ...
			                    <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_orders">
									...
									<c:forEach items="${list}" var="item">
										<tr role="row">
											...
											<td class="text-align-left"><a href="/contents/book/${item.book_id}/${item.language_id}.dr">${item.title}</a></td>
...
function goDelete(book_id) {
	if(confirm('삭제하시겠습니까?')) {
		var action = '/contents/book/delete/'+book_id+'.dr';
