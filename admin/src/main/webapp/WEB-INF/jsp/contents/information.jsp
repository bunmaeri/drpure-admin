...
<div class="page-content-wrapper">
    <div class="page-content">
        <h1 class="page-title"> 유용정보 <small>Informations</small></h1>
        ${ctag:getSuccess(successMsg)}
        ${ctag:getError(errroMsg)}
        <div class="row">
	        <div class="col-md-12">
	        	<!-- BEGIN FORM-->
	            <form action="/contents/information.dr" id="form" class="horizontal-form">
	                ...
	                <div class="portlet-body form">
	                    <div>
	                        <div class="form-actions right">
	                        	<a href="/contents/information/add.dr" data-toggle="tooltip" title="새로 추가" class="btn green"><i class="fa fa-plus"></i> 추가</a>
	                        </div>
                        </div>
	                </div>
	            </div>
...
function goPage(page) {
	var action = '/contents/information.dr';
	$('#page').val(page);
...
function goDelete(information_id) {
	if(confirm('삭제하시면 사용하는 메뉴에 에러가 발생할 수 있습니다.\n삭제하시겠습니까?')) {
		var action = '/contents/information/delete/'+information_id+'.dr';
		$("#form").attr("action", action);
		$('#form').submit();
	}
}
