...
<div class="page-content-wrapper">
    <div class="page-content">
        <h1 class="page-title"> 건강정보 <small> edit health information</small></h1>
        ${ctag:getSuccess(successMsg)}
        ${ctag:getError(errroMsg)}
        <div class="row">
	        <div class="col-md-12">
	            <!-- Begin: life time stats -->
	            <form action="/contents/security/health/contents/save.dr" id="form" class="form-horizontal form-row-seperated">
	            	<div class="portlet light portlet-fit portlet-datatable bordered">
		                <div class="portlet-title">
		                    ...
		                    <div class="actions">
	                    		<button type="button" class="btn dark" id="button_back" onclick="javascript:location='/contents/security/health/cancel.dr'"><i class="fa fa-reply"></i> BACK</button>
	                        				...
	                        				<div class="col-md-1" style="width:11%">
	                        					...
	                        					<c:forEach items="${languages}" var="item">
	                        						<li <c:if test="${item.language_id==language_id}">class="active"</c:if>>
	                        							<a data-toggle="tab" href="javascript:;" onclick="javascript:location='/contents/security/health/contents/${contents_id}/${item.language_id}.dr'">
...
$('#button-submit').on('click', function() {
    $.ajax({
        url: '/contents/security/health/contents/save.dr',
        type: 'post',
