...
<div class="page-content-wrapper">
    <div class="page-content">
        <h1 class="page-title"> 메인페이지 공지사항 수정</h1>
        ${ctag:getSuccess(successMsg)}
        ${ctag:getError(errroMsg)}
        <div class="row">
	        <div class="col-md-12">
	            <!-- Begin: life time stats -->
	            <form action="/contents/notice/save/image.dr" id="form" class="form-horizontal form-row-seperated" method="POST" enctype="multipart/form-data">
...
$('#button-submit').on('click', function() {
    $.ajax({
        url: '/contents/notice/save/image.dr',
        type: 'post',
        data: $('#form input'),
        dataType: 'json',
        beforeSend: function() {
