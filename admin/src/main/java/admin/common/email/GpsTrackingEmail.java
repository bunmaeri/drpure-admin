...
public class GpsTrackingEmail {
	public static String getHtml(Map<String,Object> map) throws Exception {
		...
		sb.append("    배송회사: GPS LOGIX<br/>");
		sb.append("    운송장번호: ").append(map.get("tracking_number")).append("<br/><br/>");
		sb.append("    고객님의 배송상황을 보시려면 아래 링크를 클릭해주세요:<br>");
		sb.append("    <a href=\"http://www.gpslgx.com/tracking/index.asp?search_method=1&search_shipping_number=").append(map.get("tracking_number")).append("\" target=\"_blank\">http://www.gpslgx.com/tracking/index.asp?search_method=1&search_shipping_number=").append(map.get("tracking_number")).append("</a><br/>");
		sb.append("    링크에 문제가 있을 때에는 아래 주소로 들어가셔서 운송장번호를 입력하고 배송조회를 하십시오.<br>");
		sb.append("    <a href=\"http://www.gpslgx.com/tracking/index.asp\" target=\"_blank\">http://www.gpslgx.com/tracking/index.asp</a><br/><br/>");
