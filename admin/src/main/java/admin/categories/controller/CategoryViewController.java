...
import admin.categories.service.CategoryViewService;
...
public class CategoryViewController {
	...
	@Resource(name="categoryViewService")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value= "/category/view/meta/{category_id}/{language_id}.dr")
    public ModelAndView categoryViewMeta(HttpServletRequest request, @PathVariable String category_id, @PathVariable String language_id, CommandMap commandMap) throws Exception {
    	ModelAndView mv = new ModelAndView("/categories/category_view_meta");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value= "/category/save/meta.dr")
...
//		}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value= "/category/view/image/{category_id}/{language_id}.dr")
    public ModelAndView categoryViewImage(HttpServletRequest request, @PathVariable String category_id, @PathVariable String language_id, CommandMap commandMap) throws Exception {
    	ModelAndView mv = new ModelAndView("/categories/category_view_image");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value= "/category/save/image.dr", method = RequestMethod.POST)
    public ModelAndView categorySaveImage(HttpServletRequest request, CommandMap commandMap) throws Exception {
		ModelAndView mv = new ModelAndView("redirect:/category/view/image/"+commandMap.get2String("category_id")+"/"+commandMap.get2String("language_id")+".dr");
