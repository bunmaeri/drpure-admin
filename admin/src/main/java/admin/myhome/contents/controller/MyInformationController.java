...
import admin.myhome.contents.service.MyInformationService;
import admin.system.service.LanguagesService;

@Controller
public class MyInformationController extends BaseController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/my_contents/information.dr")
    public ModelAndView information(Pagemaker pagemaker, CommandMap commandMap) throws Exception {
    	ModelAndView mv = new ModelAndView("/my_contents/information");
    	
    	int count = 0;
    	pagemaker.setPage(pagemaker.getPage());
    	count = myInformationService.totalInformation(commandMap.getMap()); // 레코드 총 갯수 구함
    	...
    	List<Map<String,Object>> list = myInformationService.information(commandMap.getMap());
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/my_contents/information/add.dr")
    public ModelAndView informationNew(Pagemaker pagemaker, CommandMap commandMap) throws Exception {
    	ModelAndView mv = new ModelAndView("/my_contents/information_info");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/my_contents/information/info/{information_id}/{language_id}.dr")
    public ModelAndView informationEdit(@PathVariable String information_id, @PathVariable String language_id, Pagemaker pagemaker, CommandMap commandMap) throws Exception {
    	...
    	Map<String,Object> information = myInformationService.informationInfo(commandMap.getMap());
    	...
    	Map<String,Object> info = myInformationService.informationInfo(commandMap.getMap());
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/my_contents/information/save.dr")
    public ModelAndView informationSave(CommandMap commandMap) throws Exception{
		...
		if(ObjectUtils.isEmpty(validMap)) {
			...
			int count = myInformationService.isInformation(commandMap.getMap());
			if(count==0) {
				if(commandMap.getMap().get("information_id").equals("0")) {
					commandMap.put("information_id", myInformationService.maxInformationId(commandMap.getMap()));
				}
				myInformationService.addInformation(commandMap.getMap());
			} else {
				myInformationService.updateInformation(commandMap.getMap());
			}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value= "/my_contents/information/image/{information_id}/{language_id}.dr")
    public ModelAndView categoryViewImage(HttpServletRequest request, @PathVariable String information_id, @PathVariable String language_id, CommandMap commandMap) throws Exception {
    	ModelAndView mv = new ModelAndView("/my_contents/information_image");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value= "/my_contents/information/save/image.dr", method = RequestMethod.POST)
    public ModelAndView categorySaveImage(HttpServletRequest request, CommandMap commandMap) throws Exception {
		ModelAndView mv = new ModelAndView("redirect:/my_contents/information/image/"+commandMap.get2String("information_id")+"/"+commandMap.get2String("language_id")+".dr");
		...
		if(!commandMap.get2String("image").equals("")) {
			myInformationService.updateImage(commandMap.getMap());
		}
...
//		mv.addObject("success", "정상적으로 저장되었습니다.");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/my_contents/information/delete/{information_id}.dr")
    public ModelAndView deleteInformation(@PathVariable String information_id, CommandMap commandMap) throws Exception{
    	ModelAndView mv = new ModelAndView("redirect:/my_contents/information.dr");

    	commandMap.put("information_id", information_id);
    	myInformationService.deleteInformation(commandMap.getMap());
