...
import admin.myhome.contents.service.MyEtcService;
import admin.system.service.LanguagesService;

@Controller
public class MyEtcController extends BaseController {
	Logger log = Logger.getLogger(this.getClass());
	
	@Resource(name="myEtcService")
	private MyEtcService etcService;
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/my_contents/etc.dr")
    public ModelAndView contents(Pagemaker pagemaker, CommandMap commandMap) throws Exception {
    	ModelAndView mv = new ModelAndView("/my_contents/etc");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/my_contents/etc/add.dr")
    public ModelAndView contentsNew(Pagemaker pagemaker, CommandMap commandMap) throws Exception {
    	ModelAndView mv = new ModelAndView("/my_contents/etc_info");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/my_contents/etc/info/{contents_id}/{language_id}.dr")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/my_contents/etc/save.dr")
...
//		}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/my_contents/etc/delete/{contents_id}.dr")
    public ModelAndView deleteContents(@PathVariable String contents_id, CommandMap commandMap) throws Exception{
    	ModelAndView mv = new ModelAndView("redirect:/my_contents/etc.dr");
