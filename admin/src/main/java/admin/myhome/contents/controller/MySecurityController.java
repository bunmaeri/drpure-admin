...
import admin.myhome.contents.service.MySecurityService;
...
public class MySecurityController extends BaseController {
	...
	@Resource(name="mySecurityService")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/my_contents/security/{code}.dr")
    public ModelAndView security(HttpSession session, @PathVariable String code, Pagemaker pagemaker, CommandMap commandMap) throws Exception {
    	ModelAndView mv = new ModelAndView("/my_contents/"+code);
    	...
    	Map<String,Object> map = mySecurityService.security(commandMap.getMap());
    	mv.addObject("info", map.get("map"));
    	
    	int count = 0;
    	pagemaker.setPage(pagemaker.getPage());
    	count = mySecurityService.totalSecurityContents(commandMap.getMap()); // 레코드 총 갯수 구함
    	...
    	List<Map<String,Object>> list = mySecurityService.securityContents(commandMap.getMap());
    	...
    	List<Map<String,Object>> all = mySecurityService.securityContentsAll(commandMap.getMap());
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/my_contents/security/{code}/cancel.dr")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/my_contents/security/{code}/info/{language_id}.dr")
    public ModelAndView securityInfo(@PathVariable String code, @PathVariable String language_id, Pagemaker pagemaker, CommandMap commandMap) throws Exception {
    	ModelAndView mv = new ModelAndView("/my_contents/"+code+"_info");
    	...
    	Map<String,Object> health = mySecurityService.securityInfo(commandMap.getMap());
    	...
    	Map<String,Object> info = mySecurityService.securityInfo(commandMap.getMap());
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/my_contents/security/{code}/save.dr")
    public ModelAndView updatesecurity(@PathVariable String code, CommandMap commandMap) throws Exception{
		...
		if(ObjectUtils.isEmpty(validMap)) {
			mySecurityService.updateSecurity(commandMap.getMap());
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/my_contents/security/{code}/add.dr")
    public ModelAndView securityContentsNew(@PathVariable String code, Pagemaker pagemaker, CommandMap commandMap) throws Exception {
		ModelAndView mv = new ModelAndView("/my_contents/"+code+"_contents");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/my_contents/security/{code}/contents/{contents_id}/{language_id}.dr")
    public ModelAndView securityContentsInfo(@PathVariable String code, @PathVariable String contents_id, @PathVariable String language_id, Pagemaker pagemaker, CommandMap commandMap) throws Exception {
    	...
    	commandMap.put("language_id", 1);
    	commandMap.put("code", code);
    	Map<String,Object> main = mySecurityService.securityContentsInfo(commandMap.getMap());
    	 ...
    	 */
    	commandMap.put("language_id", language_id);
    	Map<String,Object> info = mySecurityService.securityContentsInfo(commandMap.getMap());
    	mv.addObject("info", info.get("map"));
...
//    	commandMap.put("language_id", 1);
//    	List<Map<String,Object>> productList = myProductsService.autocompleteProducts(commandMap.getMap());
//    	mv.addObject("productList", productList);
    	
    	if(code.equals("disease")) {
	    	commandMap.put("medicine_id", "2");
	    	mv.addObject("required_products", mySecurityService.securityContentsMedicine(commandMap.getMap()));
	    	
	    	commandMap.put("medicine_id", "3");
	    	mv.addObject("additional_products", mySecurityService.securityContentsMedicine(commandMap.getMap()));
    	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/my_contents/security/{code}/contents/save.dr")
    public ModelAndView updatesecurityContents(@PathVariable String code, CommandMap commandMap) throws Exception{
		...
		if(ObjectUtils.isEmpty(validMap)) {
			commandMap.put("code", code);
			int count = mySecurityService.isSecurityContents(commandMap.getMap());
			if(count==0) {
				if(commandMap.getMap().get("contents_id").equals("0")) {
					commandMap.put("contents_id", mySecurityService.maxSecurityContentsId(commandMap.getMap()));
				}
				mySecurityService.addSecurityContents(commandMap.getMap());
			} else {
				mySecurityService.updateSecurityContents(commandMap.getMap());
			}
			
			// 해당 질병과 추천생약제의 전체 제품 삭제
			mySecurityService.deleteSecurityContentsMedicine(commandMap.getMap());
				...
				if(classType.equals("[Ljava.lang.String;")) {
					...
					if(null!=required_category_product) {
						...
						for(int i=0;i<size;i++) {
							...
							mySecurityService.addSecurityContentsMedicine(commandMap.getMap());
						}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/my_contents/security/{code}/delete/{contents_id}.dr")
    public ModelAndView deletesecurityContents(@PathVariable String code, @PathVariable String contents_id, CommandMap commandMap) throws Exception{
    	ModelAndView mv = new ModelAndView("redirect:/my_contents/"+code+".dr");

    	commandMap.put("contents_id", contents_id);
    	mySecurityService.deleteSecurityContents(commandMap.getMap());
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/my_contents/security/{code}/autocomplete.dr")
    public ModelAndView autocomplete(@PathVariable String code, CommandMap commandMap) throws Exception{
    	...
    	List<Map<String,Object>> list = mySecurityService.securityContentsAll(commandMap.getMap());
