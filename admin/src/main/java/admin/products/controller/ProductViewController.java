...
public class ProductViewController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value= "/product/view/meta/{product_id}/{language_id}.dr")
    public ModelAndView productViewMeta(HttpServletRequest request, @PathVariable String product_id, @PathVariable String language_id, CommandMap commandMap) throws Exception {
    	ModelAndView mv = new ModelAndView("/products/product_view_meta");
    	 ...
    	 * 한글 제품 Meta 조회
    	 */
    	Map<String,Object> product = productViewService.productMeta(commandMap.getMap());
    	 ...
    	 * 제품 Meta 조회
    	 */
    	Map<String,Object> info = productViewService.productMeta(commandMap.getMap());
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value= "/product/save/meta.dr")
    public ModelAndView productSaveMeta(HttpServletRequest request, CommandMap commandMap) throws Exception {
		...
		if(ObjectUtils.isEmpty(validMap)) {
			...
			if(null!=info && null!=info.get("product_id")) {
				productViewService.updateProductMeta(commandMap.getMap()); // 업데이트
			} else {
				if(!commandMap.get2String("product_id").equals("0")) {
					productViewService.addProductMeta(commandMap.getMap()); // 추가
				} else {
					commandMap.put("model", productViewService.maxModel()); // MAX 모델번호 가져오기
					...
					productViewService.newProduct(commandMap.getMap()); // 제품 테이블에 신규로 추가
...
//		}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value= "/product/view/info/{product_id}/{language_id}.dr")
    public ModelAndView productViewInfo(HttpServletRequest request, @PathVariable String product_id, @PathVariable String language_id, CommandMap commandMap) throws Exception {
    	ModelAndView mv = new ModelAndView("/products/product_view_info");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value= "/product/save/info.dr")
    public ModelAndView productSaveInfo(HttpServletRequest request, CommandMap commandMap) throws Exception {
		...
		if(ObjectUtils.isEmpty(validMap)) {
			...
			if(null!=info && null!=info.get("product_id")) {
				productViewService.updateProduct(commandMap.getMap()); // 업데이트
				productViewService.updateProductQuantity(commandMap.getMap()); // 제품 수량 업데이트
			} else {
...
//				} else {
//					int cnt = productViewService.duplicateModel(model);
//					if(cnt>0) {
...
//		}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value= "/product/view/image/{product_id}/{language_id}.dr")
    public ModelAndView productViewImage(HttpServletRequest request, @PathVariable String product_id, @PathVariable String language_id, CommandMap commandMap) throws Exception {
    	ModelAndView mv = new ModelAndView("/products/product_view_image");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value= "/product/save/image.dr", method = RequestMethod.POST)
    public ModelAndView productSaveImage(HttpServletRequest request, CommandMap commandMap) throws Exception {
		ModelAndView mv = new ModelAndView("redirect:/product/view/image/"+commandMap.get2String("product_id")+"/"+commandMap.get2String("language_id")+".dr");
...
//			commandMap.put("image", commandMap.get2String("original_image"));
			productViewService.updateImage(commandMap.getMap());
		}
...
//		mv.addObject("success", "정상적으로 저장되었습니다.");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value= "/product/save/image/ajax.dr")
...
//			commandMap.put("image", commandMap.get2String("original_image"));
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value= "/product/view/category/{product_id}/{language_id}.dr")
    public ModelAndView productViewCategory(HttpServletRequest request, @PathVariable String product_id, @PathVariable String language_id, CommandMap commandMap) throws Exception {
    	ModelAndView mv = new ModelAndView("/products/product_view_category");
    	...
    	List<Map<String,Object>> list = productViewService.categoriesList(commandMap.getMap());
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value= "/product/save/category.dr")
    public ModelAndView productSaveCategory(HttpServletRequest request, CommandMap commandMap) throws Exception {
		ModelAndView mv = new ModelAndView("redirect:/product/view/category/"+commandMap.get2String("product_id")+"/"+commandMap.get2String("language_id")+".dr");
		
		System.err.println(commandMap.get2String("category_ids"));
		productViewService.deleteProductCategory(commandMap.getMap());
...
//		mv.addObject("success", "정상적으로 저장되었습니다.");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value= "/product/view/disease/{product_id}/{language_id}.dr")
    public ModelAndView productViewDisease(HttpServletRequest request, @PathVariable String product_id, @PathVariable String language_id, CommandMap commandMap) throws Exception {
    	ModelAndView mv = new ModelAndView("/products/product_view_disease");
    	...
    	List<Map<String,Object>> mustList = productViewService.diseaseSecurityContentsMedicine(commandMap.getMap());

    	mv.addObject("mustList", mustList);
    	
    	commandMap.put("medicine_id", 3); // 추가 추천 생제
    	List<Map<String,Object>> addList = productViewService.diseaseSecurityContentsMedicine(commandMap.getMap());
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value= "/product/save/disease.dr")
    public ModelAndView productSaveDisease(HttpServletRequest request, CommandMap commandMap) throws Exception {
		ModelAndView mv = new ModelAndView("redirect:/product/view/disease/"+commandMap.get2String("product_id")+"/"+commandMap.get2String("language_id")+".dr");
		
		System.err.println(commandMap.get2String("must_contents_ids"));
		productViewService.deleteSecurityContentsMedicine(commandMap.getMap());
...
//		mv.addObject("success", "정상적으로 저장되었습니다.");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value= "/product/view/discount/{product_id}/{language_id}.dr")
    public ModelAndView productViewDiscount(HttpServletRequest request, @PathVariable String product_id, @PathVariable String language_id, CommandMap commandMap) throws Exception {
    	ModelAndView mv = new ModelAndView("/products/product_view_discount");
    	...
    	commandMap.put("language_id", language_id);
    	List<Map<String,Object>> list = productViewService.productSpecial(commandMap.getMap());
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value= "/product/save/discount.dr")
    public ModelAndView productSaveDiscount(HttpServletRequest request, CommandMap commandMap) throws Exception {
		ModelAndView mv = new ModelAndView("redirect:/product/view/discount/"+commandMap.get2String("product_id")+"/"+commandMap.get2String("language_id")+".dr");
		...
		productViewService.addProductSpecial(commandMap.getMap());
